...
```{r}
first_stage <- lm(proposed_turbine_3km ~ log_wind_power + log_home_val_07 + p_uni_degree + log_median_inc + log_pop_denc + mindistlake + mindistlake_sq + longitude + long_sq + latitude + lat_sq + long_lat + as.factor(district_id),
                  data = matched_data)
...
log_home_val_07 + p_uni_degree + log_median_inc + log_pop_denc + mindistlake + mindistlake_sq + longitude + long_sq + latitude + lat_sq + long_lat + as.factor(district_id),
                  data = matched_data)
